...
class FalsyAsNullSerializer<T>(private val delegate: KSerializer<T?>) : KSerializer<T?> {
 ...
 */
fun <T : Any> FalsyAsNullSerializer(delegate: KSerializer<T>): FalsyAsNullSerializer<T> =
  FalsyAsNullSerializer(delegate.nullable)
